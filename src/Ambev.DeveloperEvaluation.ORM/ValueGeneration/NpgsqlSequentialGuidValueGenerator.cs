...
namespace Ambev.DeveloperEvaluation.ORM.ValueGeneration;

/// <summary>
/// Generates sequential GUIDs using the Version 7 format (UUID v7) according to RFC 9562.
/// This generator creates time-ordered, globally unique identifiers optimized for database indexing performance.
/// </summary>
/// <remarks>
/// UUID v7 embeds a timestamp in the most significant bits, ensuring that generated GUIDs are naturally
/// ordered by creation time. This provides better database index performance compared to random GUIDs,
/// particularly in PostgreSQL environments where B-tree index insertion benefits from sequential values.
/// </remarks>
...
#pragma warning disable IDE0007 // Use implicit type -- Avoid changes to code borrowed from BCL
    ...
    private readonly struct GuidDoppleganger
    {
